  ...
  <body>
    ...
    <form class="form-horizontal" action="add_new_referral.php" method="post" enctype="multipart/form-data">
        ...
        <h3>Checklist of documents required</h3>
            ...
            <div class="row"><div class="col-md-4">Copy of Refer Slip</div><div class="col-md-4"><input type="text" name="Copy of Refer Slip" placeholder="Page No." /></div><div class="col-md-4"><input type="checkbox"></div> </div>
            <div class="row"><div class="col-md-4">Permission</div><div class="col-md-4"><input type="text" name="Permission" placeholder="Page No." /></div><div class="col-md-4"><input type="checkbox"></div> </div>
